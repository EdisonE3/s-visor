...
#define S_VISOR_VMEXIT_SYNC                0
#define S_VISOR_VMEXIT_IRQ                 1
#define S_VISOR_VMEXIT_FIQ                 2
#define S_VISOR_VMEXIT_ERR                 3
#define S_VISOR_HYP_SYNC                   4
#define S_VISOR_HYP_IRQ                    5
#define S_VISOR_HYP_FIQ                    6
#define S_VISOR_HYP_ERR                    7
...
/* Shared ISS field definitions for sys register access aborts */
#define ESR_ELx_SYS64_ISS_RT_SHIFT	5
#define ESR_ELx_SYS64_ISS_RT_MASK	(0x1f << ESR_ELx_SYS64_ISS_RT_SHIFT)

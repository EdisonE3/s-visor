...
/*------------------------------------------------------------------*/
#if BL_XTQ_AT_EL3
/* Put BL_XTQ towards the middle of the Trusted SRAM */
#define BL_XTQ_BASE			(ARM_TRUSTED_SRAM_BASE + \
						(PLAT_ARM_TRUSTED_SRAM_SIZE >> 1) + 0x2000)
#define BL_XTQ_LIMIT			(ARM_BL_RAM_BASE + ARM_BL_RAM_SIZE)

#else
/*
 * Put BL_XTQ just below BL1.
 */
#define BL_XTQ_BASE			(BL1_RW_BASE - PLAT_ARM_MAX_BL_XTQ_SIZE)
#define BL_XTQ_LIMIT			BL1_RW_BASE
#endif	/*BL_XTQ_AT_EL3*/
/*------------------------------------------------------------------*/
...
#define PAGE_SIZE_SHIFT     U(12)
#define PAGE_SIZE           (U(1) << PAGE_SIZE_SHIFT)
#define PAGE_SIZE_MASK      (PAGE_SIZE - U(1))

#define S_VISOR_RO_BASE		BL32_BASE
#define	S_VISOR_RO_LIMIT		(BL32_BASE \
						+ (UL(1) << 21))
#define	S_VISOR_RO_SIZE		S_VISOR_RO_LIMIT - S_VISOR_RO_BASE


#define S_VISOR_RW_BASE		S_VISOR_RO_LIMIT
#define	S_VISOR_RW_LIMIT		(S_VISOR_RW_BASE \
						+ (UL(1) << 21))
#define	S_VISOR_RW_SIZE		S_VISOR_RW_LIMIT - S_VISOR_RW_BASE

#define TSP_RO_BASE				S_VISOR_RW_LIMIT
#define TSP_RO_LIMIT			(S_VISOR_RW_LIMIT \
						+ (UL(1) << 21))
#define TSP_RO_SIZE				TSP_RO_LIMIT - TSP_RO_BASE

#define TSP_RW_BASE				TSP_RO_LIMIT
#define TSP_RW_LIMIT			(TSP_RO_LIMIT \
						+ (UL(1) << 21))
#define TSP_RW_SIZE				TSP_RW_LIMIT - TSP_RW_BASE

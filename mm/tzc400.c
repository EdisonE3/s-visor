...
#define FVP_TZC_BASE 0x2a4a0000
#define FVP_TZC_NUM_FILTER 1
/*
...
static tzc400_instance_t tzc400 = {
    .base = FVP_TZC_BASE,
    .num_filters = FVP_TZC_NUM_FILTER
};
...
struct lock tzc_lock;
void tzc400_init(void) {
    lock_init(&tzc_lock);
    tzc_disable_filters();
    tzc_configure_region(1 << 0x0, 0, 0, 0, 0x3, 0x83038303);
    tzc_configure_region(0x0, 1, 0, 0, 0, 0);
    tzc_configure_region(0x0, 2, 0, 0, 0, 0);
    tzc_configure_region(0x0, 3, 0, 0, 0, 0);
    tzc_configure_region(0x0, 4, 0, 0, 0, 0);
    //tzc_configure_region(1 << 0x0, 1, 0, 0, 0, 0);
    //tzc_configure_region(1 << 0x0, 2, 0, 0, 0, 0);
    //tzc_configure_region(1 << 0x0, 3, 0, 0, 0, 0);
    //tzc_configure_region(1 << 0x0, 4, 0, 0, 0, 0);
    tzc_enable_filters();
}
